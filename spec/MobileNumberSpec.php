...
use Cherif\AlgerianPhoneNumber\MobileNumber;
use PhpSpec\ObjectBehavior;

class MobileNumberSpec extends ObjectBehavior
{
    function it_throws_for_mobilis_phone_number_length_after_local_indicative()
    {
        $this->beConstructedFromString('06990000');
        $this->shouldThrow(InvalidMobileNumberException::class)->duringInstantiation();
    }
    ...
    function it_can_compare_with_0_and_00213_indicatives()
    {
        ...
        $other = MobileNumber::fromString('00213600000000');
    ...
    {
        $this->beConstructedFromString('0600000000');
        $other = MobileNumber::fromString('+213600000000');
        $this->equals($other)->shouldReturn(true);
    }
